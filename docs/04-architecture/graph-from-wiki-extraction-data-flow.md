# Data Flow: graph-from-wiki-extraction
...
| Condition | Reason |
|---|---|
| Review status is not `APPROVED` or `PUBLISHED` | `UNAPPROVED_WIKI_PAGE` |
| Confidence is below `0.800` | `LOW_CONFIDENCE_WIKI_PAGE` |
| No source refs, chunk refs, or source documents | `MISSING_WIKI_SOURCE_TRACE` |
