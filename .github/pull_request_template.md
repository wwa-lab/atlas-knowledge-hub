...
For detailed standards, see [DEVELOPMENT_STANDARDS.md](../DEVELOPMENT_STANDARDS.md), [FRONTEND_CODING_STANDARD.md](../docs/FRONTEND_CODING_STANDARD.md), and [CLAUDE.md](../CLAUDE.md).
